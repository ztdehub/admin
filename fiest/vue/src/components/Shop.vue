<template>
  <div>
          ...
          <div class="leftNav">
            <ul>
              <li v-for="item in sort">
                ...
                <div class="zj">
                  <div class="zj_l">
                    <div class="zj_l_c" v-for="srt in item.sos">
                      <h2 >{{srt.name}}</h2>
                      <a href="#" v-for="arr in srt.sos">{{arr.name}}</a>
                    </div>
                  </div>
                  <div class="zj_r">
    ...
    <div class="i_bg bg_color">
      ...
      <div class="content">
        <div class="fresh_mid">
          <ul v-for="arr in time">
            <li>
              <router-link :to="{path:  '/product', query:{aId:arr[1]}}">
              <div class="name"><a href="#">{{arr[0]}}</a></div>
              <div class="price">
